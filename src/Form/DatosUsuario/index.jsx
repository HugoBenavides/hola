    ...
    <Box
      ...
      onSubmit={(e) => {
        ...
        if (email.valid && password.valid) {
          ...
          console.log("Aun no puedes pasar al siguiente formulario");
        }
      }}
    >
      <TextField
        ...
        onChange={
          ...
          } // se optimizo el codigo para actualizar el valid dependiendo de las const y function importadas desde otro componente
        }
      />
      <TextField
        label="Contraseña"
